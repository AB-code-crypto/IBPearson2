'''
скрипт для полной проверки непрерывности 5-секундной истории в price DB. Ищет внутренние разрывы по bar_time_ts, считает количество пропущенных баров и
умеет игнорировать заранее описанные штатные биржевые паузы: клиринг, выходные, DST и отдельные праздничные исключения.
'''
